...
<footer class="bg-color page">
    ...
    <div class="row py-4 justify-content-around">
        <div class="col-lg-4 pt-1">
            <a href="index.php" class="d-inline-block">
                <img src="images/logo2.png" alt="logo" class="d-inline-block align-top logo-footer pb-5">
            </a>
        </div>
        <div class="col-xl-3 col-lg-4 pb-5">
            ...
            <div>
                <a href="https://it.linkedin.com/in/andrea-costacurta-5188bb35" target="_blank" class="fas-link"><i class="fab fa-linkedin"></i><p class="d-inline-block pl-4 mb-0">Profilo linkedin</p></a>
            </div>
        </div>
        <div class="col-lg-4">
    ...
    <div class="text-left">
        <a role="button" class="login-btn" href="login.php">Login</a>
    </div>
</footer>